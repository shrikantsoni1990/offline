...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    /**
     * Action bar helper code to be run in {@link Activity#onCreateOptionsMenu(Menu)}.
     *
    ...
    /**
     * Returns a {@link MenuInflater} that can read action bar metadata on
    ...
    /**
     * Returns the {@link ViewGroup} for the action bar on phones (compatibility action
     ...
     * MenuItem}. If the menu item ID is <code>menu_refresh</code>, the menu item's
    ...
    /**
     * A {@link MenuInflater} that reads action bar metadata.
     */
