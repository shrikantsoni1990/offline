    ...
    public void onCreate(Bundle savedInstanceState) {        
        ...
        sendLog.setOnPreferenceClickListener(new OnPreferenceClickListener(){
        	public boolean onPreferenceClick(Preference preference){
        		...
        		WakefulIntentService.scheduleAlarms(new AlarmListener(1), getApplicationContext());
        ...
        updateInterval.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
			public boolean onPreferenceChange(Preference preference, Object newValue) {
				WakefulIntentService.scheduleAlarms(new AlarmListener(Long.parseLong(newValue.toString())), SettingsActivity.this);
