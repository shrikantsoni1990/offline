...
public class WalletActivity extends AppCompatActivity {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.defaultTheme) {
            new FinestWebView.Builder(this).titleDefault("Softhinkers Virtual Wallet - Users")
                               .toolbarScrollFlags(0)
                                .webViewJavaScriptEnabled(true)
                                .webViewUseWideViewPort(false)
                                .show("http://www.softhinkers.com/bank/");
        } else if (view.getId() == R.id.redTheme) {
            //            Intent intent = new Intent(this, WebViewActivity.class);
            //            startActivity(intent);
            new FinestWebView.Builder(this).theme(R.style.RedTheme)
                    .titleDefault("Softhinkers Virtual Wallet - Admin")
...
//                            + "TheFinestArtist"
//                            + "!';")
                    .show("http://softhinkers.com/bank/admin/");
        } else if (view.getId() == R.id.blueTheme) {
            new FinestWebView.Builder(this).theme(R.style.FinestWebViewTheme)
                    .titleDefault("Softhinkers Virtual Wallet")
                    .showUrl(false)
