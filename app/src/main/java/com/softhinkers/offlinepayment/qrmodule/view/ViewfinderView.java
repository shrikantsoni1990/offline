...
package com.softhinkers.offlinepayment.qrmodule.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        paint = new Paint();
        paint.setTextSize(context.getResources().getDisplayMetrics().scaledDensity * 15);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawText(hintString, frame.centerX(), frame.bottom + frame.height() / 4, paint);
