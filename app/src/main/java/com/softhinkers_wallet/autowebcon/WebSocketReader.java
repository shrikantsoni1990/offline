...
*/
                    ...
                    mFrameHeader.setPayloadLength((int) payload_len1);
                   ...
                   /* if (masked) {
                    ...
                    return true;//mFrameHeader.getPayloadLength() == 0 || mApplicationBuffer.position() >= mFrameHeader.getTotalLength();
    ...
    public void run() {
        ...
        while (!mStopped) {
            try {
                ...
                int bytesRead =1;// mInputStream.read(mNetworkBuffer);
                if (bytesRead > 0) {
