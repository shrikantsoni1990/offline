...
import com.softhinkerswallet.graphenej.api.GetAccountByName;
import com.softhinkerswallet.graphenej.crypto.SecureRandomGenerator;
...
import com.softhinkers_wallet.models.MerchantEmail;
...
import com.softhinkerswallet.graphenej.Invoice;
import com.softhinkerswallet.graphenej.LineItem;
import com.softhinkerswallet.graphenej.Transaction;
import com.softhinkerswallet.graphenej.TransferTransactionBuilder;
import com.softhinkerswallet.graphenej.UserAccount;
import com.softhinkerswallet.graphenej.api.TransactionBroadcastSequence;
...
public class SendScreen extends BaseActivity implements IExchangeRate, ContactSelectionListener {
   ...
   @BindView(R.id.llMemo)
    LinearLayout llMemo;
   @BindView(R.id.llLoyalty)
    LinearLayout llLoyalty;
   @BindView(R.id.llBackupAsset)
    LinearLayout llBackupAsset;
   @BindView(R.id.tvLoyaltyStatus)
    TextView tvLoyaltyStatus;
   @BindView(R.id.tvTotalStatus)
    TextView tvTotalStatus;
   @BindView(R.id.spAssets)
    Spinner spAssets;
   @BindView(R.id.tvLoyalty)
    TextView tvLoyalty;
   @BindView(R.id.tvBackupAsset)
    TextView tvBackupAsset;
   @BindView(R.id.tvBackupAssetBalanceValidate)
    TextView tvBackupAssetBalanceValidate;
   @BindView(R.id.webviewFrom)
    WebView webviewFrom;
   @BindView(R.id.webviewTo)
    WebView webviewTo;
   @BindView(R.id.etReceiverAccount)
    EditText etReceiverAccount;
   @BindView(R.id.tvErrorRecieverAccount)
    TextView tvErrorRecieverAccount;
   @BindView(R.id.tvAmountStatus)
    TextView tvAmountStatus;
   @BindView(R.id.cbAlwaysDonate)
    CheckBox cbAlwaysDonate;
   @BindView(R.id.etMemo)
    EditText etMemo;
   @BindView(R.id.etAmount)
    EditText etAmount;
   @BindView(R.id.etBackupAsset)
    EditText etBackupAsset;
   @BindView(R.id.spinnerFrom)
    Spinner spinnerFrom;
   @BindView(R.id.btnSend)
    Button btnSend;
   @BindView(R.id.etLoyalty)
    EditText etLoyalty;
   @BindView(R.id.tvFrom)
    TextView tvFrom;
    int count = 0;
   @BindView(R.id.tvBlockNumberHead_send_screen_activity)
    TextView tvBlockNumberHead;
   @BindView(R.id.tvAppVersion_send_screen_activity)
    TextView tvAppVersion;
   @BindView(R.id.ivSocketConnected_send_screen_activity)
