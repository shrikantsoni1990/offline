...
import com.softhinkers_wallet.models.LangCode;
...
public class SettingActivity extends BaseActivity implements BackupBinDelegate {
   ...
   @BindView(R.id.spTimeZones)
    Spinner spTimeZones;

   @BindView(R.id.spAccounts)
    Spinner spAccounts;

   @BindView(R.id.spBackupAsset)
   ...
   @BindView(R.id.tvBlockNumberHead_content_settings)
    TextView tvBlockNumberHead;

   @BindView(R.id.tvAppVersion_content_settings)
    TextView tvAppVersion;

   @BindView(R.id.tvAccounts)
    TextView tvAccounts;

   @BindView(R.id.tvMerchantPath)
    TextView tvMerchantPath;

   @BindView(R.id.spFolderPath)
    Spinner spFolderPath;

   @BindView(R.id.backup_ic)
    ImageView backup_ic;

   @BindView(R.id.brainkey_ic)
    ImageView brainkey_ic;

   @BindView(R.id.pin_ic)
    ImageView pin_ic;

    Boolean inittLocale = false;

   @BindView(R.id.ivSocketConnected_content_settings)
